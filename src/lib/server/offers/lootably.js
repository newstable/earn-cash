...
const lootably = async(next, conversion) => {
    const response = await fetch("https://api.lootably.com/api/v1/offers/get?apiKey=w0n4d5i536dnjwk1jhzcl82embvrj9stygjj9nw5ioem&placementID=ckrw6b5gd001z01wy2cre0uga&categories=app,survey,signup,video,quiz,freetrial");
    ...
    for (var i = 0; i < data.data.length; i++) {
        ...
        try {
            const o = new Offer({
                ...
                mobile_app: offer.devices.includes("ipad") || offer.devices.includes("iphone") || offer.devices.includes("android"),
                mobile_app_type: offer.devices.includes("android") ? "android" : offer.devices.includes("ipad") ? "ipad" : "ios",
                v: next,
