...
export const GET = async (request) => {
  ...
  const securityHash = getHash(
    `userid=${searchParams.get("u")}&amount=${searchParams.get(
      "a"
    )}&offerid=${searchParams.get("oid")}&conversionid=${searchParams.get(
      "cid"
    )}&payout=${searchParams.get("p")}&ip=${searchParams.get(
      "ip"
