...
const private_key = "p0w33sWUQnZYpO9RFn5PGph9V16WXQqYFTugRhj7Qwj5SozqoHOhQVMNTUUhMK08GxR4JLSjZUY9rHRTNVA"
export const GET = async (request) => {
    ...
    if(searchParams.get("hash") != genSHA256Hash(`${searchParams.get("userID")}${searchParams.get("ip")}${searchParams.get("payout")}${searchParams.get("amount")}${private_key}`))
