<script>
    ...
    const getPage = async (page = 1) => {
        const response = await fetch("/api/admin/rewards?sent=1&    page=" + page.toString());
                            ...
                            <tbody>
                                {#each items as item}
                                    <tr>
                                        ...
                                        <td>
                                            {days4date(string2date(item.reward.sentDate), string2date(item.reward.date))} days
                                        </td>
                                        <td>
