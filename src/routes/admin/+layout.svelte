<script>
	import Sidebar from './../../components/admin/sidebar/Sidebar.svelte';
</script>

<svelte:head>
    <link rel="stylesheet" id="bootstrap-css-link" href="/css/bootstrap.min.css">
	...
	<link rel="stylesheet" href="/css/button-colors.css">
