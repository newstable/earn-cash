...
<div class="info-container" style="margin: 0 0 0 auto">
    <svg
        width="7"
        height="9"
        viewBox="0 0 7 9"
    ...
    <div class="desc">
        {#if type === "RTP"}
            <p>
                RTP: <span class="white">{rtp}%</span>
            </p>
            <div class="decoration-arrow"></div>
        {:else}
            <p>
                TYPE: <span class="white">{type}</span>
            </p>
            <div class="decoration-arrow"></div>
        {/if}
    </div>
