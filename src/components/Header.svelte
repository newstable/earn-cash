<script>
    ...
    const openMenu = () => {
        ...
        setTimeout(() => document.body.addEventListener("click", onClickSomewhere), 200);
    }
                ...
                <div class="account-item dropdown">
                    ...
                    <ul class="dropdown-menu" class:show={showAccountMenu}>
                        <li class="user-menu-item">
                            <a href="/myprofile">
                                <span>
                                    <Icon icon="mdi:user-outline" color="#a9a9ca" width="26" height="26" />
                                </span>
                                Profile
                            </a>
                        </li>
                        <li class="user-menu-item">
                            ...
                            <a on:click={() => logout()} style="cursor: pointer;">
                                <span>
                                    <Icon icon="material-symbols:logout" color="#a9a9ca" width="26" height="26" />
                                </span>
                                Log out
                            </a>
                        </li>
