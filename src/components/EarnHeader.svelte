<script>
    ...
    const getValues = () => {android, computer, apple};
...
<div class="header">
    ...
    <div class="filters">
        <div class="filter">
            <span>on</span>
            <span>
                <button on:click={() => showDropdown = !showDropdown} bind:this={button}>
                    <span class="earn-select-dropdown-toggle-left-content">
                        {#if android}
                            <Icon icon="uim:android" color="white" width="20" height="20" />
                        {/if}
                        {#if computer}
                            <Icon icon="mingcute:computer-line" color="white" width="20" height="20" />
                        {/if}
                        {#if apple}
                ...
                <ul class="dropdown-menu" class:show={showDropdown} bind:this={dropdown}>
                    <li>
                        <button class="dropdown-item" on:click={() => {android = !android; onChange()}}>
                            <span class="left">
                                <span class="icon">
                                    <Icon icon="uim:android" color="#a9a9ca" width="20" height="20" />
                                </span>
                    ...
                    <li>
                        <button class="dropdown-item" on:click={() => {computer = !computer; onChange()}}>
                            <span class="left">
                                <span class="icon">
                                    <Icon icon="mingcute:computer-line" color="#a9a9ca" width="20" height="20" />
                                </span>
                    ...
                    <li>
                        <button class="dropdown-item" on:click={() => {apple = !apple; onChange()}}>
                            <span class="left">
                                <span class="icon">
                                    <Icon icon="uim:apple" color="#a9a9ca" width="20" height="20" />
                                </span>
