<script>
  ...
  export let user = {};
  export let errorMessage = null; // Add a variable to store the error message
  let pollingInterval; // Variable to store the polling interval

  // note: this code is transferred to the parent component
  // because the code is repeating the fetch call everytime so we call it only once in parent component
...
<a
  href="/earn/{wallUrl}"
  class:disabled={errorMessage !== null || user.level < wallLevels[wallUrl]}
>
  <div class="wall">
